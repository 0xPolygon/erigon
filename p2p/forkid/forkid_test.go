	...
	tests := []struct {
		...
		},
		{
			...
			[]testcase{
				...
				{7836330, 1741159764, ID{Hash: ChecksumToBytes(0x88cf81d9), Activation: 1706655072, Next: 1741159776}}, // Last Cancun block
		...
		},
		{
			...
			[]testcase{
				...
				{34062000, 0, ID{Hash: ChecksumToBytes(0x0d260e78), Activation: 34062000, Next: 0}},        // First LisovoPro block
				{40000000, 0, ID{Hash: ChecksumToBytes(0x0d260e78), Activation: 34062000, Next: 0}},        // Future block
			},
		},
		{
			...
			[]testcase{
				...
				{83756500, 0, ID{Hash: ChecksumToBytes(0xec57f346), Activation: 83756500, Next: 0}},        // First Lisovo+LisovoPro block
				{90000000, 0, ID{Hash: ChecksumToBytes(0xec57f346), Activation: 83756500, Next: 0}},        // Future block
			},
		},
	}
